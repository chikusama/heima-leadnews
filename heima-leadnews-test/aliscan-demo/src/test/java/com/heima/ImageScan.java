...
public class ImageScan {
    public static final String ACCESS_KEY_ID = "LTAIf0X2CuvkQVsi";

    public static final String SECRET = "byR9tJkdKnOEFrzthCOkdNj6K0PrqE";


    @Test
    public void testImageScan() {
        IClientProfile profile = DefaultProfile
                .getProfile("cn-shanghai", "LTAIf0X2CuvkQVsi", "byR9tJkdKnOEFrzthCOkdNj6K0PrqE");
        DefaultProfile
         ...
         * porn：表示色情场景检测。
         */
        httpBody.put("scenes", Arrays.asList("porn", "terrorism", "ad", "live", "qrcode"));
        ...
        try {
            url = clientUploader.uploadFile("E:\\tlias\\导入模块\\黑马头条\\day04-自媒体文章审核\\资料\\图片素材\\1.jpg");
        } catch (Exception e) {
            e.printStackTrace();
        }
